...
pub struct Config<InputT> {
    pub meta: Meta<InputT>,
    pub profiles: Vec<Profile<InputT>, MAX_PROFILES>,
}
...
#[derive(Serialize, Deserialize, Debug, PartialEq, Clone)]
pub struct Meta<InputT> {
    pub version: u32,
    pub nickname: String<MAX_NICKNAME_LEN>,
    pub device: Device,
    pub color: u32,
    pub pin_remappings: Vec<PinRemapping<InputT>, MAX_PIN_REMAPPINGS>,
}
...
pub struct PinRemapping<InputT> {
    pub input: InputT,
    // TODO: make u8
    pub pin: u32,
}
...
pub struct Mapping<InputT> {
    ...
    pub input_set: Vec<InputT, MAX_DPEDAL_INPUTS>,
